...
{
    public class TokenServiceOld : ITokenServiceOld
    {
        ...
        public TokenServiceOld(ApplicationDbContext context, IConfiguration configuration)
        {
        ...
        public string GenerateToken(string userName, string password)
        {
            ...
            if (user == null || !ValidarSenha(user, password))
            {
        ...
        public bool ValidateCredentials(string userName, string password)
        {
            // Validar credenciais do usuário
            var user = _context.Set<Usuario>().FirstOrDefault(u => u.Nome == userName);
            return user != null && ValidarSenha(user, password);
        }

        private bool ValidarSenha(Usuario user, string password)
        {
